...
void InputSettings::setPreGainFormat(const char *format) {
  PreGain.setFormat(format);
}


void InputSettings::setPreGainSelection(const float *selection, size_t n) {
  PreGain.setSelection(selection, n);
}
